            ...
            <div className=" overflow-x-auto ">
                <div className="flex justify-between items-center py-3 pl-2">
                    ...
                    <div className="flex-1 relative max-w-xs">
                        ...
                        <input
                            ...
                            id="hs-table-search"
                            className="block w-full p-3 pl-10 text-sm border-gray-100 rounded-md focus:border-blue-500 focus:ring-blue-500 bg-gray-900 bg-opacity-60 hover:bg-opacity-100 dark:border-gray-700 dark:text-gray-400"
                            placeholder="Search..."
                        />
                ...
                <div className="p-1.5 w-full inline-block align-middle" dir='rtl'>
                    <div className="overflow-auto scrollbar-thin border border-gray-500 rounded-lg">
                        <table>
                            <TableHead rows={['ژمارەی وەسڵ', 'کڕیار', 'کۆی وەسڵ']} />
