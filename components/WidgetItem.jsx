...
const WidgetItem = () => {
    return (
        <div className='rounded-md inline-block mr-4 align-top mt-3 p-4 bg-white w-auto text-gray-700 text-[14px] shadow-xl shadow-gray-700 hover:bg-gray-800 hover:text-white hover:cursor-pointer'>
            <h3>Sales</h3>
