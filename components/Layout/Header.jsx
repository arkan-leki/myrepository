...
const Header = ({ sate, handleState }) => {
    return (
        <>
            <header className={` flex-nowrap flex flex-row w-full ${sate ? 'right-0' : 'md:right-48 right-44'} bg-neutral-800 bg-opacity-50 shadow-sm  relative top-0 items-center justify-start `}>
